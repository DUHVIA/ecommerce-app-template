...
@Composable
fun PasswordLeadingIcon(modifier: Modifier = Modifier) {
    Icon(
...
@Composable
fun PasswordPlaceholder(text: String, modifier: Modifier = Modifier) {
    Text(
        text = text,
...
fun PasswordField(
    ...
    TextFieldBase(
        ...
        modifier = modifier,
        placeholder = {
            PasswordPlaceholder(text = placeholderText)
        },
        leadingIcon = {
            PasswordLeadingIcon()
        },
